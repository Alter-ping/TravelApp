//package com.compose.travelapp.domain
//
//
...
//import com.compose.travelapp.Booking
//import com.compose.travelapp.domain.interceptors.AmadeusHeadersInterceptor
//import com.compose.travelapp.domain.tools.GeneratedCodeConverters
//import com.compose.travelapp.domain.tools.NumbersAdapter
//import com.compose.travelapp.domain.tools.TypesAdapterFactory
//import com.compose.travelapp.domain.tools.XNullableAdapterFactory
...
//
//    @Throws(Exception::class)
//    suspend inline fun <reified T> next(success: ApiResult.Success<List<T>>) = process(NEXT, success)
//
//    @Throws(Exception::class)
//    suspend inline fun <reified T> self(success: ApiResult.Success<List<T>>) = process(SELF, success)
//
//    @Throws(Exception::class)
//    suspend inline fun <reified T> previous(success: ApiResult.Success<List<T>>) = process(PREVIOUS, success)
//
//    @Throws(Exception::class)
//    suspend inline fun <reified T> first(success: ApiResult.Success<List<T>>) = process(FIRST, success)
//
//    @Throws(Exception::class)
//    suspend inline fun <reified T> last(success: ApiResult.Success<List<T>>) = process(LAST, success)
//
//    @Throws(Exception::class)
//    suspend inline fun <reified T> process(
//        key: String,
//        success: ApiResult.Success<List<T>>
//    ): ApiResult.Success<List<T>>? {
//        return withContext(dispatcher) {
...
//                    type
//                )
//                val adapter = moshi.adapter<ApiResult.Success<List<T>>>(resultType)
//
